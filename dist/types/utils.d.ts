...
export declare function isNestedParamAggregateFunction(functionFieldExp: FieldFunctionExpression): boolean;
...
export declare function getWhereValue(value: any | any[], literalType?: LiteralType | LiteralType[], operator?: Operator): any;
